...
import { DEFAULT_MUTED_HEX, type DocxTheme } from "@/lib/export/docx/blocks";
import {
...
const theme: DocxTheme = { font: "Inter", accentColorHex: "111827", mutedColorHex: DEFAULT_MUTED_HEX };

export function buildAtsPlainDocx(data: ResumeData, locale: Locale): Document {
