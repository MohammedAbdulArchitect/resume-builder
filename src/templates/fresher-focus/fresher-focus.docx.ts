...
const theme: DocxTheme = { font: "Inter", accentColorHex: "111827", mutedColorHex: "595959" };

// Education + Projects promoted before Experience — see index.tsx.
export function buildFresherFocusDocx(data: ResumeData, locale: Locale): Document {
